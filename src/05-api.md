...
**API Implementation**: The REST API is implemented using the Rocket framework. All API routes are defined in the [server/src/api](https://github.com/42ByteLabs/konarr/tree/main/server/src/api) directory.
...
The agent token is generated by the server and stored as `agent.key` in the [ServerSettings table](https://github.com/42ByteLabs/konarr/blob/main/src/models/settings/mod.rs). You can retrieve it from the admin panel (Settings page) or by querying the database directly.

**Key Points:**

- Agent tokens grant access to specific endpoints for uploading snapshots and creating projects
- Token validation checks a cached value first, then falls back to database lookup (implemented in [authentication guards](https://github.com/42ByteLabs/konarr/blob/main/server/src/guards/mod.rs))
...
**Authentication Endpoints** ([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/auth.rs)):

- **Login**: `POST /api/auth/login`
- **Logout**: `POST /api/auth/logout`  
- **Registration**: `POST /api/auth/register`

Sessions are validated on each request and cached in memory for performance. Users can be assigned `Admin` or `User` roles ([user model](https://github.com/42ByteLabs/konarr/blob/main/src/models/auth/users.rs)).
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/projects.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/snapshots.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/dependencies.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/security.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/user.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/admin.rs))
...
([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/websock.rs))
...
**GET** `/api/` ([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/base.rs))
...
**GET** `/api/health` ([implementation](https://github.com/42ByteLabs/konarr/blob/main/server/src/api/health.rs))
